    ...
    return (
        <article className='flex gap-2 items-start rounded-3xl tansition-all duration-500 ease-in-out' key={post?.$id}>
            ...
            <div className="flex flex-col gap-2 items-stretch justify-between h-[500px] w-[40%] rounded-3xl tansition-all duration-500 ease-in-out">
                ...
                <div className="flex flex-col gap-3 items-stretch p-3 max-h-[250px] w-full rounded-3xl border border-white bg-white/80 tansition-all duration-500 ease-in-out">
                    <Tabs
